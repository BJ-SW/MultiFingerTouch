...
def main():
    try:
        ...
        MultiFingerTouch 4 Cases:
            This is sample code for the 4 cases - single probe,multi finger vertical swipers,
...
def Case2_vertical_swipers():
    try:
        '''
             Case2 - Multi finger vertical swipers
